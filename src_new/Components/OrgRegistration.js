...
export default class OrgRegistration extends Component {
    ...
    render() {
        return (
            <div>
                <br/>
                <h1 id="headAddOrg">Add New Organiser</h1>
                ...
                <input id="org_contact" type="number" placeholder="Enter Organisation Contact No. ..." onChange={(event)=>this.setState({org_contact:event.target.value})}/>
                <br/><br/>
                ...
                <br/>
            <button id="btnOrgAcc" variant="primary" onClick={this.setRedirect}>Create Account </button>
            {this.renderRedirect()}
            </div >
            </div>
        )
