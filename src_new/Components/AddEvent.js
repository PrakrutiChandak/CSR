...
export default class AddEvent extends Component {
    ...
    setRedirect = () => {
      ...
      addEvent=()=>
      {
          if(this.state.redirect)
          {
            ...
            alert("Eevent Added successfully!!!")
    ...
    render() {
        return (
                <div>
                <h1 id="headAddEve">Add New Event</h1>
...
<br/><br/>
      ...
      <br/>
      <button id="pubNInvite" variant="primary" onClick={this.setRedirect}> Publish And Invite </button>
      {this.addEvent()}
    </div>
</div>
        )
